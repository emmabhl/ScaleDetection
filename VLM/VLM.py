...
def VLM_scale_detection(
    ...
    Args:
        ...
        output_folder (str): The folder to save output JSON files.
    ...
    def resize_max_side(pil_img: Image.Image, max_side: int):
        ...
        return pil_img.resize((new_w, new_h), resample=Image.LANCZOS) # pyright: ignore[reportAttributeAccessIssue]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--filepath", type=str, default="data/annot", 
                        help="Path to the directory containing images")
    parser.add_argument("--output_folder", type=str, default="outputs_vlm", 
                        help="Folder to save output JSON files")
    parser.add_argument("--model_id", type=str, default="Qwen/Qwen3-VL-8B-Instruct", 
                        help="Pre-trained VLM model ID")
    parser.add_argument("--max_side", type=int, default=2048, 
